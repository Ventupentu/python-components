...
RELAY_ACTUATOR_NAME      = 'RelayActuator'
...
VIBRATION_SENSOR_NAME = 'VibrationSensor'
...
DEFAULT_CONFIG_FILE_NAME = '/home/ventura/Documents/IOT/python-components/config/PiotConfig.props'
